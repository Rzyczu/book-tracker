        ...
        <div className="p-4">
                    ...
                    <section className="mb-6 rounded-md border bg-white p-4">
                        ...
                        <div className="h-3 w-full overflow-hidden rounded bg-gray-200">
                            <div
                                ...
                                aria-label={`Ukończenie ${stats.completion}%`}
                            />
                        </div>
                        <p className="mt-2 text-xs text-gray-600">
                            {stats.read} / {stats.total} książek przeczytanych
                        </p>
                    </section>
                                    ...
                                    <li key={author}>
                                        ...
                                        <div className="mt-1 h-2 w-full rounded bg-gray-100">
                                            <div
                                                ...
                                                style={{
                                                    width: `${Math.min(100, (count / stats.topAuthors[0].count) * 100)}%`,
                                                }}
                                                aria-hidden
                                            />
                                        </div>
            ...
            {!isLoading && !isError && data && data.length === 0 && (
                <div className="rounded-md border bg-white p-4 text-sm text-gray-600">
                    Brak książek do policzenia statystyk. Dodaj pozycje na stronie głównej.
                </div>
            )}
        </div>
    );
